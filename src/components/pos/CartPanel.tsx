  ...
  return (
    <div className="flex w-full flex-col gap-3">
      ...
      <div className="rounded-2xl border border-slate-700 bg-slate-900 p-4">
        ...
        {!kitchenStation && (
          <p className="mt-1.5 text-xs text-amber-200">Selecciona una estación para continuar</p>
        )}
      </div>
              ...
              return (
                <li key={item.local_id} className="flex items-start gap-3 px-4 py-3">
                  ...
                  <button
                    ...
                    className="mt-0.5 flex h-7 w-7 min-w-[28px] shrink-0 cursor-pointer items-center justify-center rounded-full text-slate-500 transition-colors duration-150 hover:bg-amber-400/10 hover:text-amber-200"
                  >
      ...
      <div className="rounded-2xl border border-slate-700 bg-slate-900 p-4">
        {submitError && (
          <div className="mb-3 rounded-lg bg-amber-400/10 px-3 py-2 text-xs text-amber-200 ring-1 ring-amber-400/30">
            {submitError}
          </div>
        )}
        ...
        <button
          ...
          onClick={onSubmit}
          disabled={!canSubmit}
          className="w-full cursor-pointer rounded-xl bg-emerald-500 py-3.5 text-sm font-bold text-white transition-all duration-150 hover:bg-emerald-400 active:scale-95 disabled:cursor-not-allowed disabled:opacity-40 min-h-[48px]"
        >
